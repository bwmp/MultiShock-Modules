  ...
  return <>
    <section class="max-w-6xl mx-auto py-32 px-4 flex flex-col gap-4">
      ...
      <Card>
        ...
        <video controls>
          <source src="https://projects.akiradev.me/MultiShock/Multishock_v3_setup.mp4" type='video/mp4' />
        </video>
        <ul class="list-decimal">
          ...
          <li>Run the EXE</li>
          <li>Click <span class="font-bold">Settings</span> button in the GUI</li>
          ...
          <li>Click the Create HTTP Shocker button</li>

      ...
      <div class="text-center justify-center flex relative align-center w-full">
        <div class="flex flex-col gap-2 sm:gap-6 w-full px-4">
          <h1 class="text-gray-100 text-2xl sm:text-4xl font-bold fade-in animation-delay-200">
            Currently to submit a module for the community, you must contact AkiraDev on Discord.
          </h1>
          ...
          <div class="flex flex-col gap-2 mt-8 fade-in animation-delay-400">
            <div class="flex flex-col sm:flex-row gap-2 justify-center">
              <a href="https://discord.gg/EQmGcKCNyp" class="flex transition ease-in-out rounded-xl shadow-lg backdrop-blur-lg bg-pink-900/80 hover:bg-pink-700 px-6 py-3 text-pink-100 md:py-4 md:px-8 text-sm md:text-lg whitespace-nowrap gap-5 items-center">
                My Discord Server
              </a>
            </div>
          </div>
